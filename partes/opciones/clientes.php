...
<script language="javascript">
	...
	function agregar()
	{
		parent.detalle.location.href = "../detalles/clientes.php?accion=agregar";
	}
	...
	function eliminar()
	{
		...
		if(respuesta)
		{
			$.get("../../funciones/funciones_ajax.php", { llama_ajax: "elimina_cliente", cod: parent.detalle.document.formu.cod.			value  });
			parent.listado.location.href = "../listados/clientes.php";
			parent.detalle.location.href = "../detalles/clientes.php?s=eliminado";
	...
	function buscar()
	{
		parent.listado.location.href = "../listados/clientes.php?b=" + parent.opciones.document.formbus.buscar.value;
	}
